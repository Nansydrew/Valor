...
<head>
    ...
    <title><?php echo $title ?> - Промокод</title>
...
<div>
				...
				<table>
					<tbody><tr>
						<td><img alt="wow.png" src="../assets/img/icons/wow.png"><font color="orange"> Примечание:</font> Система прокодов даёт бонус. Возможно только один раз его использовать!</td>
					</tr>
					<tr>
						<td> </td>
					</tr>
...
<input type="text" id="promocode" name="promocode" class="form-control-pass" placeholder="Введите промокод" value="" aria-required="true">
