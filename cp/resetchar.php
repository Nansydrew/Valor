...
<head>
    ...
    <title><?php echo $title ?> - Исправить персонажа</title>
...
<div>
				...
				<table>
					<tbody><tr>
						<td><img alt="wow.png" src="../assets/img/icons/wow.png"><font color="orange"> Примечание:</font> Выйдите из игры чтобы перенести своего персонажа в стартовую локацию.</td>
					</tr>
					<tr>
						<td> </td>
					</tr>
...
<div class="shop_top">	
            ...
            <div class="cp-form-block">
                <div class="title">Исправить персонажа</div>
				<? include"../include/resetchar.php";?>
